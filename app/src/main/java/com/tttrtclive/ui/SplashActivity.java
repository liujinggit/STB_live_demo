...
public class SplashActivity extends BaseActivity {
    ...
    private View.OnFocusChangeListener mListener = new OnButtonFocusChangeListener();
    private View.OnFocusChangeListener mRoomIdListener = new onRoomIdFocusChangeListener();
    private View.OnFocusChangeListener mRoomEnterListener = new onRoomEnterFocusChangeListener();
    @Override
    ...
    private void initView() {
        ...
        mHostBT.requestFocus();
        mHostBT.setChecked(true);
//        mAuthorBT.requestFocus();
//        mAuthorBT.setChecked(true);
        mHostBT.setOnFocusChangeListener(mListener);
        mAuthorBT.setOnFocusChangeListener(mListener);
        mAudienceBT.setOnFocusChangeListener(mListener);
        mRoomIDET.setOnFocusChangeListener(mRoomIdListener);
        mEnter.setOnFocusChangeListener(mRoomEnterListener);
    ...
    private class OnButtonFocusChangeListener implements View.OnFocusChangeListener{
    ...
    private class onRoomIdFocusChangeListener implements View.OnFocusChangeListener{
    ...
    private class onRoomEnterFocusChangeListener implements View.OnFocusChangeListener{
